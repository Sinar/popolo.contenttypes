...
#
#  $ bin/test -s politikus.popolo -t test_source.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src politikus.popolo.testing.POLITIKUS_POPOLO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot /src/politikus/popolo/tests/robot/test_source.robot
#
...
a Source 'My Source'
  Create content  type=Person  id=my-source  title=My Source
